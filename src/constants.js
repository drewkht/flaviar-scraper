...
const HEADERS = `href	brand	name	category	rating	price	style	region	country	distillery	alcoholPercent	volume	age	totalRatings	reviewRatings	nonReviewRatings	avgReviewRatingValue	flavors.primary	flavors.secondary.1	flavors.secondary.2	flavors.secondary.3	flavors.secondary.4	flavors.tertiary.1	flavors.tertiary.2	flavors.tertiary.3	flavors.tertiary.4	appearance	flavor	smell	finish`;
